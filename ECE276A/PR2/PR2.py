...
def update_log_odds_map(pose, index, lidar, grid_map, cell_dim, shift_origin, neck_angle, head_angle):
    ...
    for k in range(num_of_lidar_coords):#for each scan of full scan rotation
        ...
        if lidar_coord > 29: #skip this scan if it's greater than 29
...
for i in range(int(num_of_scans/step_size)):
    ...
    grid_map = update_log_odds_map(pose, i*step_size, l0, grid_map, cell_dim, shift_origin, neck_angle, head_angle)
...
#                update_log_odds_map(pose, index, lidar, grid_map, cell_dim, shift_origin, neck_angle, head_angle)
#
#except IndexError:
#    print("index error")
#            
